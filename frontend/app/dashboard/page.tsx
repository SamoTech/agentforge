...
export default function DashboardPage() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold mb-2">🤖 AgentForge</h1>
      <p className="text-gray-400 mb-8">Platform overview — real-time stats</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <section className="bg-gray-900 rounded-xl p-6">
          ...
          <p className="text-gray-500 text-sm">Fetches from GET /tasks/</p>
        </section>
        <section className="bg-gray-900 rounded-xl p-6">
          <h2 className="font-semibold text-lg mb-4">Top Skills Used</h2>
          <p className="text-gray-500 text-sm">Fetches from GET /skills/stats</p>
        </section>
      </div>
    </div>
  )
