"""Skill: image_analyzer — analyze images using OpenAI Vision (GPT-4o)."""
...
class ImageAnalyzerSkill(BaseSkill):
    name = "image_analyzer"
    description = "Analyze an image (URL or local path) using GPT-4o Vision and return a description."
    category = "multimodal"
